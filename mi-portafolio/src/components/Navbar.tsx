      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between py-3 px-4 md:px-8 bg-black/40 backdrop-blur-sm rounded-b-2xl">
        <div className="flex items-center gap-3">
          ...
          <div className="hidden md:flex gap-4 ml-6">
            <a href="#hero" className="kicker hover:underline">Home</a>
            <a href="#skills" className="kicker hover:underline">Skills</a>
            <a href="#projects" className="kicker hover:underline">Projects</a>
            <a href="#testimonials" className="kicker hover:underline">Testimonials</a>
            <a href="#experience" className="kicker hover:underline">Experience</a>
            <a href="#contact" className="kicker hover:underline">Contact</a>
          </div>
        </div>

        <div className="flex items-center gap-3">
          <button onClick={()=> setLang(lang==="es"?"en":"es")} title="Toggle language" className="p-2 rounded-md hover:bg-white/5">
            <FiGlobe />
          </button>
          <button onClick={toggleTheme} title="Theme" className="p-2 rounded-md hover:bg-white/5">
